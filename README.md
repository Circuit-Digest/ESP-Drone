...
This project is a custom-built drone powered by an ESP32 microcontroller. It’s designed as a lightweight and affordable platform to explore flight dynamics, motor control, and real-time sensor integration.

The goal was to understand how a drone balances, responds to movement, and maintains stability using onboard sensors and code logic. It’s a hands-on way to learn about embedded systems and control loops while building something practical and fun.

The repository includes all the core files — code, wiring references, and setup details — so others can learn from or build upon it.
